...
from app.functions import atualizar_senha, cadastrar_usuario, autenticar_usuario, exibirSaldo, gerenciar_login_google, lerDemandas, salvarDemanda, solicitar_recuperacao_senha, validar_token, atualizar_perfil_dev, atualizar_perfil_cliente, adicionar_saldo_cliente, ler_pagamentos_cliente
...
def dashboardCliente():
    ...
    return render_template('dashboardCliente.html', form=form, demandas=demandas,foto_perfil=foto_perfil,usuario=usuario, pagamentos=pagamentos)
